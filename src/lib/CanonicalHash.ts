...
export function runCanonicalHashTests(): void {
  ...
  console.log('PASS: Key ordering deterministic');
  ...
  console.log('PASS: Number normalization');
  ...
  console.log('PASS: String escaping');
  ...
  console.log('PASS: First event added');
  ...
  console.log('PASS: Second event chained');
  
  // Test 6: Verify chain
  const result = chain.verify();
  console.assert(result.valid, `Chain should be valid: ${result.error}`);
  console.log('PASS: Chain verification passed');
  ...
  console.log('PASS: Cross-environment determinism');
  
  console.log('\nPASS: All CanonicalHash tests passed');
}
