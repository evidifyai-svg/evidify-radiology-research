      ...
      {metrics.blockers.length > 0 && (
        <div className="p-4 border-t bg-red-50">
          <h3 className="text-sm font-semibold text-red-700 mb-2 flex items-center gap-2">
            <span>Blocker</span> Blockers ({metrics.blockers.length})
          </h3>
      ...
      {metrics.warnings.length > 0 && (
        <div className="p-4 border-t bg-amber-50">
          <h3 className="text-sm font-semibold text-amber-700 mb-2 flex items-center gap-2">
            <span>Warning</span> Warnings ({metrics.warnings.length})
          </h3>
          <ul className="space-y-1">
...
export function CrossExamReadinessCompact({
  ...
  return (
    ...
    >
      <span>{metrics.score >= 85 ? 'High' : metrics.score >= 60 ? 'Medium' : 'Low'}</span>
