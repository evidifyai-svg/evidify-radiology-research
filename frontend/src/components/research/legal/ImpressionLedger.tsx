...
export const LedgerTimeline: React.FC<LedgerTimelineProps> = ({ 
  ...
  const getEntryIcon = (type: LedgerEntryType) => {
    switch (type) {
      case 'HUMAN_FIRST_IMPRESSION': return 'Human';
      case 'AI_OUTPUT_EXPOSURE': return 'AI';
      case 'AI_FINDING_ACKNOWLEDGED': return 'Acknowledged';
      case 'RECONCILIATION': return 'Reconciled';
      default: return 'Note';
    }
  };
